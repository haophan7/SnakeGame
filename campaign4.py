...
def draw_obstacles(screen, obstacles):
    for obstacle in obstacles:
        ...
        pygame.draw.rect(screen, MAROON, obstacle_rect)
...
def main():
    ...
    while running:
        ...
        obstacles_left = [[0, y] for y in range(40, SCREEN_HEIGHT - 380, CELL_SIZE)]
        obstacles_left2 = [[0, y] for y in range(420, SCREEN_HEIGHT, CELL_SIZE)]
        obstacles_right = [[SCREEN_WIDTH - CELL_SIZE, y] for y in range(40, SCREEN_HEIGHT - 380, CELL_SIZE)]
        obstacles_right2 = [[SCREEN_WIDTH - CELL_SIZE, y] for y in range(420, SCREEN_HEIGHT, CELL_SIZE)]
        obstacles_top = [[x, 40] for x in range(0, SCREEN_WIDTH, CELL_SIZE)]
        obstacles_bottom = [[x, SCREEN_HEIGHT - CELL_SIZE] for x in range(0, SCREEN_WIDTH, CELL_SIZE)]
        obstacles_center = [[x, 180] for x in range(160, SCREEN_WIDTH - 160, CELL_SIZE)]
        obstacles_center2 = [[x, 440] for x in range(160, SCREEN_WIDTH - 160, CELL_SIZE)]
        obstacles = obstacles_left + obstacles_right + obstacles_bottom + obstacles_top + obstacles_left2 + obstacles_right2 + obstacles_center + obstacles_center2
                    ...
                    if check_speed_limit(snake, food_positions, orange_positions, FPS):
                        ...
                        if black_food_eaten >= 1:
                            if not victory_message_displayed:
                                ...
                                subprocess.run(["python", "campaign5.py"])
                            break
                    else:
