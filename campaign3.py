...
def draw_obstacles(screen, obstacles):
    for obstacle in obstacles:
        ...
        pygame.draw.rect(screen, SEAGREEN, obstacle_rect)
...
def display_victory_message(screen, score):
    font = pygame.font.SysFont("monospace", 36)
    text1 = font.render("Congratulations! You won Level 3!", True, GRAY)
...
def main():
    ...
    while running:
        ...
        obstacles_left = [[160, y] for y in range(40, SCREEN_HEIGHT - 140, CELL_SIZE)]
        obstacles_right = [[SCREEN_WIDTH - 200, y] for y in range(180, SCREEN_HEIGHT, CELL_SIZE)]
        obstacles_top = [[x, 100] for x in range(600, SCREEN_WIDTH, CELL_SIZE)]
        obstacles_bottom = [[x, SCREEN_HEIGHT - 80] for x in range(0, SCREEN_WIDTH - 620, CELL_SIZE)]
        obstacles = obstacles_left + obstacles_right + obstacles_top + obstacles_bottom
                    ...
                    if check_speed_limit(snake, food_positions, orange_positions, FPS):
                        ...
                        if black_food_eaten >= 1:
                            if not victory_message_displayed:
                                ...
                                subprocess.run(["python", "campaign4.py"])
                            break
                    else:
