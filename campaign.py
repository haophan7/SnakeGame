...
def display_victory_message(screen, score):
    font = pygame.font.SysFont("monospace", 36)
    text1 = font.render("Congratulations! You won Level 1!", True, GRAY)
...
def main():
    ...
    while running:
        ...
        obstacles_left = [[0, y] for y in range(40, SCREEN_HEIGHT, CELL_SIZE)]
        obstacles_right = [[SCREEN_WIDTH - CELL_SIZE, y] for y in range(40, SCREEN_HEIGHT, CELL_SIZE)]
                    ...
                    if check_speed_limit(snake, food_positions, orange_positions, FPS):
                        ...
                        if black_food_eaten >= 1:
                            if not victory_message_displayed:
                                ...
                                subprocess.run(["python", "campaign2.py"])
                            break
                    else:
